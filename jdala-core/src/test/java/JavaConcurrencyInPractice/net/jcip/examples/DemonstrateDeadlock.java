...
import JavaConcurrencyInPractice.net.jcip.examples.DynamicOrderDeadlock.Account;
import JavaConcurrencyInPractice.net.jcip.examples.DynamicOrderDeadlock.DollarAmount;
